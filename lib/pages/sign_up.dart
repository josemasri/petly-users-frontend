...
import 'package:fluttersecretchat/api/location_api.dart';
import 'package:fluttersecretchat/utils/location.dart';
...
class _SingUpPageState extends State<SingUpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
        future: LocationUtils.getLocation(context),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.data == null) {
            return Center(child: CircularProgressIndicator());
          }
          if (!_isFetchingLocation && country == '') {
            _isFetchingLocation = true;
            LocationAPI.getLocation(context: null, locationData: snapshot.data)
                .then(
              (location) {
